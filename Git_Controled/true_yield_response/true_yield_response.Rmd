...
extd.dir = "/Users/qianqiandu/Desktop/N_Residual_APSIM/Git_Controled/true_yield_response"

write_dir = "/Users/qianqiandu/Desktop/N_Residual_APSIM/Git_Controled/true_yield_response"
...
new.date <- "2015-05-05"
# new.action <- '[Fertiliser].Apply(Amount: 0, Type: Fertiliser.Types.UAN_N, Depth: 30)'
new.action <- paste0("[Fertiliser].Apply(Amount: ",300,", Type: Fertiliser.Types.UAN_N, Depth: 30)")

# new.line <- '2015-05-05 [Fertiliser].Apply(Amount: 0, Type: Fertiliser.Types.UAN_N, Depth: 30)'
new_line <- paste0("2015-05-05 [Fertiliser].Apply(Amount: ",300,", Type: Fertiliser.Types.UAN_N, Depth: 30)")
...
new.date <- "2016-05-05"
new.action <- paste0("[Fertiliser].Apply(Amount: ",300,", Type: Fertiliser.Types.UAN_N, Depth: 30)")
new_line <- paste0("2016-05-05 [Fertiliser].Apply(Amount: ",300,", Type: Fertiliser.Types.UAN_N, Depth: 30)")
...
# saveRDS(initial_N_result, "/Users/qianqiandu/Desktop/N_Residual_APSIM/Git_Controled/OFPE_trials/initial_N_result.rds")
...
ggplot()+
  ...
  geom_line(aes(x = applied_N, y = yield), data = ofpe_2017)+
  theme_bw()+
  ggtitle("colored are the true yield response, black is the opfe yield response")
